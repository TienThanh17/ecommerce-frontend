...
export const fetchAllUserRedux = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      ...
      console.log(res);
      if (res && res.code === 0) {
        thunkAPI.dispatch(fetchAllUserSuccess(res.data));
      } else {
...
export const fetchAllBrandRedux = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      ...
      if (res && res.code === 0) {
        thunkAPI.dispatch(fetchAllBrandSuccess(res.data));
      } else {
...
export const fetchAllProductTypeRedux = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      ...
      if (res && res.code === 0) {
        thunkAPI.dispatch(fetchAllProductTypeSuccess(res.data));
      } else {
...
export const fetchAllSizeRedux = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      ...
      if (res && res.code === 0) {
        thunkAPI.dispatch(fetchAllSizeSuccess(res.data));
      } else {
...
export const fetchAllProductRedux = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      ...
      if (res && res.code === 0) {
        thunkAPI.dispatch(fetchAllProductSuccess(res.data));
      } else {
...
export const fetchAllProductSizeRedux = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      ...
      if (res && res.code === 0) {
        thunkAPI.dispatch(fetchAllProductSizeSuccess(res.data));
      } else {
...
export const fetchAllVoucherRedux = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      ...
      if (res && res.code === 0) {
        thunkAPI.dispatch(fetchAllVoucherSuccess(res.data));
      } else {
...
export const fetchAllOrderAdminRedux = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      ...
      if (res && res.code === 0) {
        thunkAPI.dispatch(fetchAllOrderSuccess(res.data));
      } else {
...
export const fetchAllProductOrderRedux = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      ...
      if (res && res.code === 0) {
        thunkAPI.dispatch(fetchAllProductOrderSuccess(res.data));
      } else {
