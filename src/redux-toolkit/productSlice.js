...
export const fetchAllProductOfTheProductTypeRedux = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      ...
      if (res && res.code === 0) {
        thunkAPI.dispatch(fetchAllProductOfTheProductTypeSuccess(res.data));
      } else {
...
export const fetchAllProductSaleOffRedux = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      ...
      if (res && res.code === 0) {
        thunkAPI.dispatch(fetchAllProductSaleOffSuccess(res.data));
      } else {
...
export const fetchAllProductFavouriteRedux = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      ...
      if (res && res.code === 0) {
        thunkAPI.dispatch(fetchAllProductFavouriteSuccess(res.data));
      } else {
...
export const productSlice = createSlice({
  ...
  reducers: {
    ...
    setCheckUpdateFeedback: (state, action) => {
      state.checkUpdateFeedback = action.payload;
    }
  },
});
